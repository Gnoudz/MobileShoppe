...
<body>
    ...
    <header id="header">
        <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
            <p class="font-size-12 text-black-50 font-rale m-0">Jordan Calderon 430-985 Eleifend St. Duluth Washington
        ...
        <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
            <a class="navbar-brand text-white" href="index.php">Mobile Shopee</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto font-rubik">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Product <i class="fa-solid fa-chevron-down"></i></a>
                    </li>
                    <li class="nav-item">
